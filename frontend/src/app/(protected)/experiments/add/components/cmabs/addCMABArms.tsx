import {
  ...
  import { CMABExperimentState, NewCMABArm, StepComponentProps } from "../../../types";
              ...
              >
                ...
                <Field className="flex flex-col">
                    ...
                    <div className="basis-3/4 flex flex-col">
                        ...
                        value={
                            "sigma_init" in arm
                            ? arm.sigma_init === 0 ? "0" : arm.sigma_init || ""
                            : ""
                        }
                        onChange={(e) => {
                            const newArms = [...arms];
                            newArms[index].sigma_init = parseFloat(e.target.value);
                            typeSafeSetExperimentState(
                              newArms as NewCMABArm[]
                            );
                        }}
