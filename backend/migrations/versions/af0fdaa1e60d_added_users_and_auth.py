...
def upgrade() -> None:
    ...
    op.create_foreign_key("fk_arms_users", "arms", "users", ["user_id"], ["user_id"])
    op.add_column("mabs", sa.Column("user_id", sa.Integer(), nullable=False))
    op.create_foreign_key("fk_mabs_users", "mabs", "users", ["user_id"], ["user_id"])
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint("fk_mabs_users", "mabs", type_="foreignkey")
    op.drop_column("mabs", "user_id")
    op.drop_constraint("fk_arms_users", "arms", type_="foreignkey")
