"""add reward and prior variables to arm

Revision ID: de3c1137582e
Revises: ac3411f604ea
Create Date: 2025-02-24 19:40:45.252164
...
def upgrade() -> None:
    ...
    op.add_column("arms", sa.Column("prior_type", sa.String(length=50), nullable=False))
    ...
    op.add_column(
        "arms", sa.Column("reward_type", sa.String(length=50), nullable=False)
    )
