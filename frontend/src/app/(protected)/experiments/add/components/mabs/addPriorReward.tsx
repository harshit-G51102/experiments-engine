...
export default function MABPriorRewardSelection({ onValidate }: StepComponentProps) {
    ...
    const validateForm = useCallback(() => {
        ...
        if (experimentState.priorType === "normal" && experimentState.rewardType === "binary") {

            newErrors.rewardType = "Normal prior is not compatible with binary reward"
            isValid = false
          }
        if (experimentState.priorType === "beta" && experimentState.rewardType === "real-valued") {

            newErrors.rewardType = "Beta prior is not compatible with real-valued reward"
            isValid = false
          }
        setErrors(newErrors)
